...
const courses = [
  ...
  },
  {
    ...
    description: 'An intermediate level course for those who have already mastered the basic concepts of English grammar.',
    icon: FaSeedling,
    color: 'from-green-400 to-emerald-300',
  },
  {
    title: 'Advanced level',
    description: 'An advanced course for those who want to perfect their English.',
    icon: FaTree,
...
export default function Leves() {
  return (
    <div className="bg-blue-500 min-h-screen py-16 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {courses.map((course, index) => (
            <div key={index} className="relative group">
              <div className={`absolute inset-0 bg-gradient-to-br ${course.color} rounded-2xl transform transition-all duration-300 group-hover:scale-105 group-hover:rotate-2`}></div>
              <div className="relative bg-white bg-opacity-90 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 group-hover:shadow-2xl">
                <div className="p-8">
                  ...
                  <h2 className="text-2xl font-bold text-blue-900 mb-4 text-center">{course.title}</h2>
